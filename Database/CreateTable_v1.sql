...
/* Created on:     17/06/2021 07:44:03                          */
/*==============================================================*/
...
create table ASSET_USER_RELATIONSHIP (
   ASSET_USER_RELATIONSHIP_ID int               not null identity(1,1),
   AS_ID                int               not null,
   U_ID                 int               not null,
...
create table HAND_OVER (
   HO_ID                int               not null identity(1,1),
   U_SEND_ASSET         int               not null,
   U_RECEIVE_ASSET      int               not null,
   HO_DATE              datetime             null,
   HO_CONntext           ntext                 null,
...
alter table HAND_OVER
   add constraint FK_HAND_OVE_RECV_HAND_USER foreign key (U_RECEIVE_ASSET)
      references "USER" (U_ID)
go

alter table HAND_OVER
   add constraint FK_HAND_OVE_SEND_HAND_USER foreign key (U_SEND_ASSET)
      references "USER" (U_ID)
go
